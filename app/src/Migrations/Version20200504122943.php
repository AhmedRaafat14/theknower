 ...
 */
final class Version20200504122943 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_likes (contribution_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_AB08B525FE5E5FBD (contribution_id), INDEX IDX_AB08B525A76ED395 (user_id), PRIMARY KEY(contribution_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE user_likes ADD CONSTRAINT FK_AB08B525FE5E5FBD FOREIGN KEY (contribution_id) REFERENCES contribution (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contribution_user (contribution_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_4E41A211A76ED395 (user_id), INDEX IDX_4E41A211FE5E5FBD (contribution_id), PRIMARY KEY(contribution_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
